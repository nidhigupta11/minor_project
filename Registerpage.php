...
<style>
  body {
    font-family: Arial;
    background-image: linear-gradient(to right, #0695A1 , #BEEFF3);
  }
</style>
...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'reg')">Register</button>
</div>
  ...
  <?php
   ...
   if(isset($_POST['Login']))
     {  
      ...
      $sel ="select * from userdata where email='$name' and password='$password'";
  ...
  <div class="row" id="form1">
    <div class="col-lg-6">
      <form action="" method="post">
        <p><h1 style=" width: 200%;">Already a User?</h1></p>
        <p><h2><u>Sign in</u></h2></p>
        <p>
          <label for="email" style="float: left; margin-left: 40%; margin-top: 10px;">Username (E-mail):</label>
          <input type="text"  class="form-control" style="width: 200px; margin-left:450px" name="email" value="" >
        </p>
        <p>
          <label for="password" style="float: left; margin-left: 40%; margin-top: 10px; ">Password:</label>
          <input type="Password"  class="form-control" style="width: 200px; margin-left:450px" name="password" value="">
        </p>
...
if (isset($_POST['Register']))
   {  $fname=$_POST['fname'];
     ...
     {
       $password=($_POST['password']);
       $as = preg_match("/^[a-zA-Z0-9!@#$%^&*()_+-]/",$password); //("/^[a-zA-Z0-9]+[!@#$%^&*()_+-]/",
       if(!$as)
        {
...
<div id="reg" class="tabcontent">
  <div class="row" id="form2">
     <div class="col-lg-6" style="width: 100%; font-size: 15px;">
      <p><h1>New User?</h1></p>
       <p><h2><u>Regiter Now</u></h2></p>
          <form action="" method="post">
            <p>First Name:<input type="text" class="form-control" style=" width: 70%; margin-left: 15%;" name="fname" value="<?php echo $fname;?>">
            <span class="error"><?php echo $fnameERR; ?></span></p>
             <p>Last Name:<input type="text" class="form-control" style=" width: 70%; margin-left: 15%;" name="lname" value="<?php echo $lname;?>">
            <span class="error"><?php echo $lnameERR; ?></span></p>
              <p>  E-mail:<input type="text" class="form-control" style=" width: 70%; margin-left: 15%;" name="email" value="<?php echo $email;?>">
            <span class="error"><?php echo $emailERR; ?></span></p><br>
              <p>Password:<input type="password" class="form-control" style=" width: 70%; margin-left: 15%;" name="password" value="<?php echo $password;?>">
            <span class="error"><?php echo $pswdERR; ?></span></p><br>
              <p>Phone no.:<input type="text" class="form-control" style=" width: 70%; margin-left: 15%;" name="phno" value="<?php echo $phno; ?>">
